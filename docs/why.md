...
`go-ruby-ipaddr/ipaddr` reimplements Ruby's [`IPAddr`](https://docs.ruby-lang.org/en/master/IPAddr.html) in **pure Go, with cgo disabled**. The
...
- any Go program can import `github.com/go-ruby-ipaddr/ipaddr` directly, with no Ruby runtime;
